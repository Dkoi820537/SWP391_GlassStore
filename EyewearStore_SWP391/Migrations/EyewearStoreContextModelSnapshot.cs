...
namespace EyewearStore_SWP391.Migrations
{
    ...
    partial class EyewearStoreContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EyewearStore_SWP391.Models.EyeExamAppointment", b =>
                {
                    ...
                    b.ToTable("EyeExamAppointments", (string)null);
                });

            modelBuilder.Entity("EyewearStore_SWP391.Models.FrameCompatibleLensType", b =>
                {
                    ...
                    b.HasKey("FrameProductId", "LensType");

                    b.ToTable("frame_compatible_lens_types", (string)null);
                });
            ...
            modelBuilder.Entity("EyewearStore_SWP391.Models.Order", b =>
                {
                    ...
                    b.HasIndex("OrderGroupId")
                        .HasDatabaseName("IX_orders_order_group");
            ...
            modelBuilder.Entity("EyewearStore_SWP391.Models.OrderStatusHistory", b =>
                {
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_order_status_history_created");
            ...
            modelBuilder.Entity("EyewearStore_SWP391.Models.Return", b =>
                {
                    ...
                    b.HasIndex("OrderItemId")
                        .HasDatabaseName("IX_returns_order_item");

                    b.HasIndex("Status")
                        .HasDatabaseName("IX_returns_status");

                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_returns_user");
            ...
            modelBuilder.Entity("EyewearStore_SWP391.Models.Lens", b =>
                {
                    ...
                    b.Property<string>("LensThickness")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
            ...
            modelBuilder.Entity("EyewearStore_SWP391.Models.FrameCompatibleLensType", b =>
                {
                    b.HasOne("EyewearStore_SWP391.Models.Frame", "Frame")
                        .WithMany("CompatibleLensTypes")
                        .HasForeignKey("FrameProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("EyewearStore_SWP391.Models.Frame", b =>
                {
                    b.Navigation("CompatibleLensTypes");
                });
