...
<div style='text-align:center;margin-top:20px'>
  <a href='https://localhost:7001/Customer/Services/EyeExam' style='{Btn("#2563eb")}'>📅 Book a New Appointment</a>
            ...
            string newStatus, string? assignedTo, string? note)
        {
            ...
            {
                "Processing" => ("⚙️", "#2563eb", "Our technicians are now working on your order."),
                "Ready" => ("🎉", "#059669", "Your glasses are ready! Please come in to collect them."),
                "Done" => ("✅", "#0a0a1a", "Your order has been completed. Thank you for choosing OptiPlus!"),
                "Cancelled" => ("❌", "#dc2626", "Your service order has been cancelled. Please contact us for details."),
                _ => ("📋", "#b8862a", "Your order status has been updated.")
            };
