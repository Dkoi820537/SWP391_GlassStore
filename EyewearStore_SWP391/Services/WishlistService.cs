...
namespace EyewearStore_SWP391.Services
{
    public interface IWishlistService
    {
        ...
        Task<List<WishlistItemDto>> GetUserWishlistAsync(int userId, int page = 1, int pageSize = 12);
    ...
    public class WishlistService : IWishlistService
    {
        ...
        public async Task<List<WishlistItemDto>> GetUserWishlistAsync(int userId, int page = 1, int pageSize = 12)
        {
